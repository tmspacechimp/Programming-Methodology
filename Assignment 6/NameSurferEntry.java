...
public class NameSurferEntry implements NameSurferConstants {
	...
	public NameSurferEntry(String line) {
		extractedName = line.substring(0, line.indexOf(" "));
		ranksString = line.substring(line.indexOf(" ")).trim();
	...
	public String getName() {
		String name = extractedName;
		return name;
	}

	private void organizeRanks() {
		String ranks = ranksString + " ";
		for (int i = 0; i < NDECADES; i++) {
			extractedRanks[i] = Integer.parseInt(ranks.substring(0, ranks.indexOf(" ")));
	...
	public String toString() {
		String readStats = extractedName + " " + "[" + ranksString + "]";
		return readStats;
	}

	private String extractedName = "";
	private int[] extractedRanks = new int[NDECADES];
