...
public interface NameSurferConstants {
	...
	/** The number of pixels from the bottom line */
	public static final int DECADE_LABEL_MARGIN_Y = 14;

	/** The number of pixels from the vertical lines */
	public static final int DECADE_LABEL_MARGIN_X = 14;
	
	/** The number of pixels dividing vertical lines from labels*/
	public static final int LABEL_MARGIN = 3;
}
