...
public interface FacePamphletConstants {
	...
	/**
	 * The number of vertical pixels in the vertical margin between the headline and
	 * friend labels
	 */
	public static final double FRIEND_MARGIN_FROM_HEADLINE = 35;

	/**
	 * The number of vertical pixels in the vertical margin between two friend
	 * labels
	 */
	public static final double FRIEND_MARGIN_FROM_FRIEND = 18;
}
